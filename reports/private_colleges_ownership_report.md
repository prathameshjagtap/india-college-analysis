...
```mermaid
graph TD
    A["351 Private Medical Colleges in India"] --> B["Political Leadership Trusts (51.3%)"]
    A --> C["Religious & Community Trusts (18.5%)"]
    A --> D["Corporate Healthcare Groups (12.2%)"]
    A --> E["Independent Educational Trusts (18.0%)"]

    B --> B1["TDP / BRS / AIMIM (AP & Telangana)"]
    B --> B2["Congress / BJP / Lingayat Maths (Karnataka)"]
    B --> B3["NCP / Congress / BJP (Maharashtra)"]
    B --> B4["DMK / AIADMK / NJP / IJK (Tamil Nadu)"]
    B --> B5["RJD / SP / BJP / TMC (North & East India)"]
```
...
```mermaid
pie title Funding Sources Breakdown of Private Medical Colleges
    "Student Tuition & Capitation Fees (State & Management Quotas)" : 45
    "Clinical Hospital Operational Revenues (OPD/IPD/Diagnostics)" : 28
    "NRI Quota Fee Premium (Up to 15% seats at 3-5x regular fees)" : 15
    "Parent Trust Endowments / Promoter Group Equity" : 8
    "Government / Corporate PPP Grants & CSR Capital" : 4
```
